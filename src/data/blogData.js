...
graph TD
  ...
  <section class="mb-14 p-8 bg-white/90 rounded-2xl shadow-lg border border-gray-100">
    ...
    <div class="flex justify-center mt-8">
      <a href="https://github.com/KVSC1511/Portfolio.git" target="_blank" class="inline-block bg-[#e13a7a] text-white font-semibold px-6 py-3 rounded-full shadow hover:bg-[#6d217f] transition-all text-lg">
